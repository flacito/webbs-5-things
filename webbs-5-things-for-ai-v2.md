...
**One more thing.** here's the prompt that made this web page:

```txt
Please understand CLAUDE_CODE_PROMPT.md and use webbs-5-things-for-ai-v2.md to get a React based SPA using ../../test-and-learn/starter-monorepo/packages/web as a starter and display the markdown as the source using a well used MD package for react.
